...
#> /tmp/RtmpXy1srL/phenotypeDiagnostics_log_{date}_{time}1d5e139a89b1.txt
#> ℹ Creating log file:
#>   /tmp/RtmpXy1srL/phenotypeDiagnostics_log_2026_07_27_11_05_181d5e139a89b1.txt.
#> [2026-07-27 11:05:18] - Log file created
#> [2026-07-27 11:05:18] - Database diagnostics - getting CDM Snapshot
#> [2026-07-27 11:05:19] - Database diagnostics - summarising person table
#> ℹ The following estimates will be calculated:
#> • date_of_birth: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-07-27 11:05:22.549023
#> ✔ Summary finished, at 2026-07-27 11:05:22.606807
#> [2026-07-27 11:05:22] - Database diagnostics - summarising observation period
...
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-07-27 11:05:25.599068
#> ✔ Summary finished, at 2026-07-27 11:05:25.667566
#> [2026-07-27 11:05:26] - Codelist diagnostics - index event breakdown
...
#> [2026-07-27 11:05:28] - Cohort diagnostics - cohort attrition
#> [2026-07-27 11:05:28] - Cohort diagnostics - cohort count
#> ℹ summarising data
#> ℹ summarising cohort warfarin
#> ✔ summariseCharacteristics finished!
#> → Skipping cohort sampling as all cohorts have less than 20000 individuals.
#> [2026-07-27 11:05:29] - Cohort diagnostics - matched cohorts
...
#> [2026-07-27 11:05:39] - Cohort diagnostics - cohort characteristics
...
#> ✔ summariseCharacteristics finished!
#> [2026-07-27 11:05:44] - Cohort diagnostics - age density
#> ℹ The following estimates will be calculated:
#> • age: density
#> ! Table is collected to memory as not all requested estimates are supported on
#>   the database side
#> → Start summary of data, at 2026-07-27 11:05:44.949708
#> ✔ Summary finished, at 2026-07-27 11:05:45.068771
...
#> [2026-07-27 11:05:45] - Cohort diagnostics - large scale characteristics
...
#>  - getting characteristics from table visit_occurrence (7 of 7) for time window…
#> Formatting result
#> 229 estimates dropped as frequency less than 1%
...
#> [2026-07-27 11:06:22] - Population diagnosics - denominator cohort
#> [2026-07-27 11:06:22] - Population diagnosics - sampling person table to 1e+05
#> people
#> ℹ Creating denominator cohorts
#> ✔ Cohorts created in 0 min and 3 sec
#> [2026-07-27 11:06:26] - Population diagnosics - incidence
...
#> [2026-07-27 11:06:35] - Population diagnosics - prevalence
...
#> elements are NA.
#> [2026-07-27 11:06:43] - Exporting log file
...
#> ℹ Shiny app created in /tmp/RtmpXy1srL/PhenotypeRShiny
